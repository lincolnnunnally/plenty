...
export const TOOMBS_COORDS: Record<string, { lat: number; lon: number }> = {
  ...
  "oasischurchofgodpantry": { lat: 32.177657, lon: -82.333338 },
  "oasischurchofgodfooddistribution": { lat: 32.177657, lon: -82.333338 },
  "oasischurchofgod": { lat: 32.177657, lon: -82.333338 },

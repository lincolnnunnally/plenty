  ...
  return (
    <main className="shell">
      ...
      <section className="panel store-card-sheet">
        ...
        <p className="note">Want a person with this food — a prayer if you want one, a next step? Food does not depend on it. <a href="/become">After groceries</a>.</p>
      </section>

      {issued ? (
        <section className="panel">
          <h2>Store staff — mark collected</h2>
          <p className="note">Hand the bag. Put the slip in it. Do not ring the gift. Do not ask them to buy anything else. Use the PIN Plenty gave this store.</p>

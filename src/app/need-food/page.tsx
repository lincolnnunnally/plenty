    ...
    <main className="shell">
      ...
      {!user ? (
        ...
        <section className="panel">
          ...
          <p className="note">Tell us how many people you are feeding and any allergies. Food is never held back because you skip a growth form.</p>
          ...
          {household ? (
            <>
              ...
              <p className="note">Ask for a delivery if you cannot get to the pantry. A volunteer will try to bring food to you.</p>
              <PostForm action="/api/pickups" submitLabel="Request a delivery">
                <input type="hidden" name="kind" value="household_delivery" />
                <label className="field"><span>Address for delivery</span><input className="input" name="address" required /></label>
                <label className="field"><span>Phone</span><input className="input" name="contactPhone" defaultValue={household.phone} /></label>
                <label className="field"><span>When you need it / notes</span><input className="input" name="notes" /></label>
              </PostForm>
